          ...
          try {
            ...
            if ((p = p instanceof HTMLElement ? p : f[f.length - 1] || null)) {
              ...
              var v = (
				...
				//   '</button></div><div class="vpower txt-right">Powered By <a>bsf</a><br>'
				// h.VERSION +
                  "</div>";
              e.$el.html(g),
          ...
          var C = function (t, n, r) {
              ...
              var l = t.get("link")
                ...
                u = T.hide
                  ...
                  : '<img class="vimg" src="' + "../../medias/fox.png" + '">',
                d =
                  u +
